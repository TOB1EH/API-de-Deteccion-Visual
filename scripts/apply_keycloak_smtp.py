...
SMTP_CONFIG = {
    ...
    "from": os.getenv("SMTP_FROM", "abrambilla804@alumnos.iua.edu.ar"),
    "fromDisplayName": "API Deteccion Visual",
    "auth": "true",
    "starttls": "true",
    "ssl": "false",
    "user": os.getenv("SMTP_USER", "abrambilla804@alumnos.iua.edu.ar"),
...
def apply_smtp_config(admin_token):
    r = requests.get(
    ...
    r.raise_for_status()
    print("SMTP + resetPassword aplicados correctamente")
    return True
