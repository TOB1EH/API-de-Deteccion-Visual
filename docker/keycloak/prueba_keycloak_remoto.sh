#!/bin/bash
# Prueba exhaustiva de Keycloak + API (remoto - bfts2026.mooo.com)
# Ejecutar: bash docker/keycloak/prueba_keycloak_remoto.sh

set +e

BASE="https://bfts2026.mooo.com"
...
echo "=============================================="
echo " Prueba Keycloak - REMOTO (bfts2026.mooo.com)"
echo "=============================================="
echo ""
